import numpy as np
from ..ll_functions import  one_energy_cy, all_energy_cy
import pytest
...
def test_all_energy(input_arr, expected_energy):
    ...
    calculated_energy = all_energy_cy(input_arr, nmax)
...
def test_one_energy(input_arr, ix, iy, nmax, expected_energy):
    calculated_energy = one_energy_cy(input_arr, ix, iy, nmax)
    assert calculated_energy == expected_energy
